...
from CSPACE_TEST import Scene_Creator
from getToursAndPaths import getFinalPath
from gridLP import compute_flux_pseudo_3d, examplePolygonList, exampleObstacleNodes, exampleEdges, get_grid_points_res, get_vs_graphs, get_irradiation_matrix, get_scene_details
...
def main():
    ...
    for roomnum in range(0,25):
        fileName = './adjacency_matrices/iteration_'+str(roomnum)+'/scene_'+str(roomnum)+'.p'
